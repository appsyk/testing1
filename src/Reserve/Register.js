...
class Register extends React.Component {
  render() {
    return (
      <div>
     <h1>Register for Reserve your vehicle</h1>
     <h3>Registration form is Under Construction....sry mam</h3>
      {/* <div className="container register">
        <div className="row">
          <div className="col-md-3 register-left">
            <img src="https://www.iconspng.com/uploads/green-parking/green-parking.png" alt="form_Pic"  /> <br />
            <h3>Welcome</h3>
            <br />
          </div>
