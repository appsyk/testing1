    ...
    return (
      ...
      <div>
        <section id="contact">
          <div className="container">
            <div className="row">
            <h4 style={{ marginRight: '4%' }} ><Link to="/reserve-place@BADLAPUR"  className="btn custom-btn btn-info"><span className="glyphicon glyphicon-list fa-2x"  ></span>WATCH THE LIST</Link></h4>
              ...
              <div className="colmd-12">
                <div className="contact_area text-center">
                  ...
                  <h2 style={{ marginTop: '-1%' }}>Station Rd, Patil Pada, Kulgaon, Badlapur, Maharashtra 421503</h2>
                </div>
              </div>
            </div>
            <SeatBox />
