...
class CreateAiroliStation extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.ref.add({
      ...
      this.props.history.push("/reserve-place@AIROLI_STATION")
    })
      .catch((error) => {
      ...
      <div className="container">
        <div>
          <section id="contact">
            <div className="container">
              <div className="row">
                <h4 ><Link to="/reserve-place@AIROLI_STATION" className="btn custom-btn btn-info"><span className="glyphicon glyphicon-list fa-2x" style={{ marginRight: '4%' }} ></span>WATCH THE LIST</Link></h4>

                <div className="colmd-12">
                  <div className="contact_area text-center" >
                    <h3 style={{ marginTop: '-4%', marginLeft: '22%', marginRight: '20%' }} >Airoli station parking</h3>
                    ...
                    <table className="squaredOne">
                      <tbody><tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <label className="check-container">
                              <input type="checkbox" onClick={this.onBoxClick} defaultValue="E1" checked={this.test('F1')} />
                              <span className="checkmark"></span>
                            </label>
                          </td>
                          <td>
                            <label className="check-container">
                              <input type="checkbox" onClick={this.onBoxClick} defaultValue="E2" checked={this.test('F2')} />
                              <span className="checkmark"></span>
                            </label>
                          </td>
                          <td>
                            <label className="check-container">
                              <input type="checkbox" onClick={this.onBoxClick} defaultValue="E3" checked={this.test('F3')} />
                              <span className="checkmark"></span>
                            </label>
                          </td>
                          <td className="form-check">
                            <label className="check-container">
                              <input type="checkbox" onClick={this.onBoxClick} defaultValue="E4" checked={this.test('F4')} />
                              <span className="checkmark"></span>
                            </label>                          </td>
                          <td>
                            <label className="check-container">
                              <input type="checkbox" onClick={this.onBoxClick} defaultValue="E5" checked={this.test('F5')} />
                              <span className="checkmark"></span>
                            </label>
                          </td>
                          <td />
...
export default CreateAiroliStation;
